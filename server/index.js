...
const urls = [
  ...
  'https://lh3.googleusercontent.com/ljghORnAFCY6fMLTBOrWogBm8qRd9AM9dq6bV8N7QnrHEZ-dc-GxXx08Ub4Zq3RRXgChTegzurhCBZYmtUm-Jj7VV-SWe0hjUbKdVSVILsyPABGmIv8AgZqrB4hVhOv2ffShZa7TodWbExoU8NJ5tq3MZs5ARR7RHgL0IOfWa-qyxjng1De0L5j5sQAx01cSpmVqMAdWhx51GY-HAXCWFIU2pZkQSpICbyVInAi0orlsdZ0yxWF5XI9WKo5Qz1amrtgRcIuG9WUWIP2pjLQdsq-bDuvYaEHSGmRrkCspxsG0rXm08WxMeEO6xr22CO7dszGxeSSFJXXWxvUajk3DEPHMel1p8IwEL9rzvXyYX3YX0z_cM_o87Um8OqYwmbMApIa0pSbosagHAIPBvbWE3svaU419UzvFqZzwzGu_qwDvHZrXkJMmn_Lc7JbkcKRpDrENzkPf5JgStNAzqJUh73MtRutjHGaiwm8DB51QMJAXXS3Qy2eh8fKTUWb3fdxHvjFdYwzXYfzo1z6_SfBIMYGovrzYNgLx3qRd4XUVw8_sm2g2EeJ1AkJvibLmtuggyeggJwT4x7Bd4I8cNQDVnLmTJHVNNeWDrtSUCdHN_WjOGW1BEIgoWbefv-i7vSriG2PPUuwNZho7Pc28mO6tYqI2pnLG_Mll=w807-h1209-no'
];
...
io.on('connection', (socket) => {
  ...
  socket.on('action', (action) => {
    console.log(`server receive: ${JSON.stringify(action)}`)
    socket.emit('action', action);
  })
  const timeoutHandler = (count) => {
    socket.emit('action', { type: 'NEXT_PIC', data: { showPicIndex: count } });
    setTimeout(timeoutHandler, 5000, (count + 1) % urls.length);
  }
